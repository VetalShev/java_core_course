...
public class CdRom {
    ...
    // если не создать данный конструктор - отсутсвует возможность создания локольной переменной типа CdRom c конструктором без параметров [RESOLVED]
    public CdRom() {} // нужен ли здесь этот конструктор ??? В каких стуациях он может быть нужен ??? [RESOLVED]
